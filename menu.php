	...
	<div id="cssmenu-container">
		...
		<nav id="cssmenu">
			...
			if(isset($_SESSION['user'])){
				$muni = isset($_SESSION["city_mun"]) ? urlencode($_SESSION["city_mun"]) : "PAGADIAN";
				$bara = isset($_SESSION["barangay"]) ? urlencode($_SESSION["barangay"]) : "SAN+PEDRO";
				...
				<ul>
					...
					<li><a href='mcelist.php' id='mce' title='Barangay Chairman'>Chairman</a></li>
					<li><a href='bcelist.php' id='bce' title='Barangay Kagawad'>Kagawad</a></li>
					...
					<li class='has-sub'>
						...
						<ul>
							<li><a href='voter_id_cards.php' id='idcards'>Voter ID Cards</a></li>
							<li><a href='summaryreport.php' id='sum1'>Report 80% ETO</a></li>
							<li><a href='counter.php' id='counter'>Exit Pool Counter</a></li>
							<li><a href='hllist_grid.php' id='sumhl'>HL & Members List</a></li>
							<li><a href='hl-indiv.php' id='sumform'>HL & Members Form</a></li>
						</ul>
					</li>";
					
			if($_SESSION["access"] === "SuperAdmin"){
				echo"<li class='has-sub'>";
				echo"<a id='sum' href='#' onclick='return false;'>Admin <i class='fa-solid fa-chevron-down' style='font-size: 10px;'></i></a>";
				echo"	<ul>";
				echo"      <li><a href='users.php' id='users' title='Users'>Users</a></li>";
				echo"      <li><a href='backup.php' id='back'>Backup</a></li>";
				echo"	   <li><a onclick='switchDatabase()' id='pl02010' title='SK Voters' style='cursor:pointer;'>SK Voters</a></li>";
