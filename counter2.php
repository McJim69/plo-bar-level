			...
			<div class="col-md-4">
				<div class="card card-glass h-100 text-center p-3 border-0">
					<div class="card-body">
						...
						<h2 class="display-5 fw-bold text-dark mt-2"><?php echo number_format($totvoters,0); ?></h2>
					</div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="card card-glass h-100 text-center p-3 border-0">
					<div class="card-body">
						...
						<h2 class="display-5 fw-bold text-dark mt-2"><?php echo number_format($totTRV,0); ?></h2>
