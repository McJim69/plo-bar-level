...
<div class="container my-4">
	...
	<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-3">
		<div class="d-flex align-items-center gap-3">
			<img src="images/alayon-big.png" height="50" alt="Logo" class="d-none d-sm-block" />
			<div>
				<h1 class="display-6 fw-bold text-danger mb-0">EXIT POLL COUNTER</h1>
				<span class="text-muted">Real-time Turnout Analytics</span>
			</div>
		</div>
		<img src="images/iloveyudark.png" height="45" alt="Campaign Logo" class="d-none d-sm-block" />
	</div>
	...
	<div class="card-glass p-3 mb-4">
		<div class="row g-3 align-items-center justify-content-between">
			<div class="col-lg-6 d-flex gap-2 flex-wrap">
				<a href="counter.php" class="btn btn-danger rounded-pill px-4 fw-bold"><i class="fa-solid fa-chart-pie me-2"></i> Overview</a>
				<a href="counter2.php?municipality=<?php echo urlencode($municipality); ?>&barangay=<?php echo urlencode($barangay); ?>" class="btn btn-outline-secondary rounded-pill px-4 fw-bold"><i class="fa-solid fa-list-check me-2"></i> Detailed Breakdown</a>
				<button type="button" class="btn btn-success rounded-pill px-4 fw-bold" onclick="getVoters('');add();"><i class="fa-solid fa-plus me-2"></i> Add Votes</button>
			</div>
			<div class="col-lg-6">
	...
	?>
		...
		<div class="card-glass p-0 overflow-hidden shadow-sm">
			<div class="bg-danger text-white px-4 py-3 d-flex align-items-center justify-content-between">
				<h5 class="mb-0 fw-bold"><i class="fa-solid fa-map-location-dot me-2"></i> Breakdown for Barangay: <?php echo htmlspecialchars($barangay); ?></h5>
				<span class="badge bg-white text-danger fw-bold fs-6">City: <?php echo htmlspecialchars($municipality); ?></span>
			</div>
					...
					<tbody>
						<?php
							...
							while($rs = $ex->fetch(PDO::FETCH_BOTH)){
								...
								// 5. Total Members Calculation (MCE + BCE + PL + HL + Members - Undecided - Swd)
	...
	?>
		...
		<div class="row g-4 mb-5">
			...
			<div class="col-md-4">
				<div class="card card-glass h-100 text-center p-3 border-0">
					<div class="card-body">
						...
						<h2 class="display-5 fw-bold mt-2"><?php echo number_format($totvoters,0); ?></h2>
					</div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="card card-glass h-100 text-center p-3 border-0 bg-danger text-white bg-opacity-95 shadow">
			...
			<div class="col-md-4">
				<div class="card card-glass h-100 text-center p-3 border-0">
					<div class="card-body">
						...
						<h2 class="display-5 fw-bold mt-2"><?php echo number_format($totTRV,0); ?></h2>
