...
<style>
	.hide-members .hlmember {
		display: none !important;
	}
	/* Match all borders on screen */
	#grid table, 
	#grid th, 
	#grid td {
	...
	@media print {
		...
		/* High contrast styles for table elements when printed */
		.table-dark {
...
<div class="container my-4">
	...
	<div id="grid" class="card-glass p-4 overflow-hidden">
		...
		<DIV style="text-align:center;background:#fff;display:none" id='header' class="text-dark mb-4">
			...
			<h5 class="fw-bold">CITY OF <?PHP echo htmlspecialchars($_SESSION["city_mun"]); ?></h5>
			<?php
						...
						while($rs=$ex->fetch(PDO::FETCH_BOTH)){
							...
							echo"
								<tr class='table-dark align-middle'>
									<td colspan='2' class='fw-bold px-3 py-2'>".$i.". ".htmlspecialchars($rs["vname"])."</td>
									...
									<td colspan='3' class='fw-bold px-3 py-2 text-warning small'>PL: ".htmlspecialchars($pl_name)."</td>
								</tr>
